...
static void test_copy_null(void) {
    ASSERT_NULL(SNEPPX_tensor_copy(NULL), "copy NULL -> NULL");
}

static void test_clone_null(void) {
    ASSERT_NULL(SNEPPX_tensor_clone(NULL), "clone NULL -> NULL");
}
...
static void test_reshape_null(void) {
    size_t ns[] = {6};
    ASSERT_NULL(SNEPPX_tensor_reshape(NULL, ns, 1), "reshape NULL -> NULL");
}
...
static void test_permute_null(void) {
    size_t axes[] = {1, 0};
    ASSERT_NULL(SNEPPX_tensor_permute(NULL, axes), "permute NULL -> NULL");
}
...
static void test_expand_null(void) {
    size_t ns[] = {2, 3};
    ASSERT_NULL(SNEPPX_tensor_expand(NULL, ns, 2), "expand NULL -> NULL");
}
...
static void test_expand_fewer_dims(void) {
    ...
    size_t ns[] = {6};
    ASSERT_NULL(SNEPPX_tensor_expand(t, ns, 1), "expand fewer dims -> NULL");
...
static void test_unsqueeze_invalid_dim(void) {
    ...
    ASSERT_NULL(SNEPPX_tensor_unsqueeze(t, 5), "unsqueeze dim>ndim -> NULL");
    SNEPPX_tensor_destroy(t);
}
...
static void test_concat_null(void) {
    ASSERT_NULL(SNEPPX_tensor_concat(NULL, 0, 0), "concat NULL -> NULL");
}
...
static void test_split_null(void) {
    ASSERT_NULL(SNEPPX_tensor_split(NULL, 2, 0), "split NULL -> NULL");
}
...
static void test_slice_null(void) {
    ASSERT_NULL(SNEPPX_tensor_slice(NULL, 0, 0, 1), "slice NULL -> NULL");
}
