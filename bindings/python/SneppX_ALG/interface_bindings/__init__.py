...
# Phase 3 Extended — New security modules
...
# Phase 10 — Serving, quantization formats, JAX-style transforms, MLOps
...
__all__ = [
    ...
    "halving_search",
    "bayesian_search",
    # Phase 10 — serving, MX formats, JAX-style transforms, MLOps
    "ContinuousBatchScheduler",
    "ScheduledRequest",
    "BatchResult",
    "PagedAttentionConfig",
