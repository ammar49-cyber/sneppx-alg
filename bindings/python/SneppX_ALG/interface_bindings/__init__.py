...
from .nn_functional import (  # torch.nn.functional-compatible namespace
    relu,
    leaky_relu,
    elu,
    selu,
...
__all__ = [
    ...
    "TransformerBlock",
    "Transformer",
    # torch.nn.functional namespace (F.*); the name `functional` is reserved by
    # the pre-existing autograd functional module, so use the `F` alias.
    "F",
    "relu",
    "leaky_relu",
    "elu",
